...
class Settings():
    ...
    def set(self, section, config, newConfig):
        # Update some game settings in .cfg file
        configParser[section][config] = str(newConfig)
        with open('gameSettings.cfg', 'w') as configFile:
            configParser.write(configFile)

    def openScreen(self, screen_size, display):
        # Organizing setting menu
        ...
        bgrounds = {
            'MountainsSunset': pygame.image.load('assets/images/backgrounds/MountainsSunset.png'),
            'DarkForest': pygame.image.load('assets/images/backgrounds/DarkForest.png'),
            'DarkSunset': pygame.image.load('assets/images/backgrounds/DarkSunset.png')
            }
        ...
        while not backToGame and not quit:
            # Getting mouse event to change settings
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    save_button = pygame.draw.rect(display, (200, 100, 50), save_button, border_radius=10)
                    font = pygame.font.Font('freesansbold.ttf', 30)
